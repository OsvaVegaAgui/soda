        ...
        <div class="card custom-card">
            ...
            <div class="card-body">
                <div class="table-responsive">
                    <table id="tabla_ticket" class="table table-bordered text-nowrap w-100">
                        <thead>
                            <tr>
                                <th>Nombre ticket</th>
                                <th>Codigo ticket</th>
                                ...
                                <th>Categoria de tickect</th>
                                <th>Categoria Instituto</th>
                                <th>Editar</th>
                                <th>Eliminar</th>
                            </tr>
                        </thead>
                        <tbody>
                            @foreach($tickets as $ticket)
                                <tr>
                                    ...
                                    <td>{{ $ticket->categoriaTicket->nombre }}</td>
                                    <td>{{ $ticket->categoria_instituto->nombre }}</td>

                                    <td>
                                        <a href="{{ route('ticketes-soda', ['accion' => 'editar_view', 'id' => $ticket->id_ticket]) }}" class="btn btn-sm btn-warning">
                                            Editar
                                        </a>
                                    </td>
                                    ...
                                    <td>
                                        <form method="POST"
                                            ...
                                            @csrf
                                            <div id="toastMensaje" class="toast-mensaje"></div>
                                            <button type="submit"
