...
<div class="card-body px-5 py-4">
    ...
    <div class="card-header  text-white py-3" style="border-radius: 15px 15px 0 0;">
        <h5 class="mb-0">
            <i class="bi bi-people-fill me-2"></i>Editar Usuarios
        </h5>
    </div>
    
    <form id="formEditarUsuarios"   action="{{ route('usuarios', ['accion' => 'editar', 'id' => $usuario->id]) }}"  method="POST">
        @csrf
        ...
        <div class="mb-4">
            ...
            <div class="input-group">
                ...
                <input type="password" name="password" class="form-control form-control-lg" 
                       placeholder="(Opcional) Escribe una nueva contraseña…">
            </div>
